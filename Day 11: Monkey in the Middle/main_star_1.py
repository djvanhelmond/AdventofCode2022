...
class Monkey():
    ...
    def turn(self):
        ...
        while len(self.items) > 0:
            ...
            monkeys[str(self.do_test(item))].items.append(str(item))
    ...
    def update_worry(self, item):
        ...
        print("    Monkey gets bored with item. Worry level is divided by 3 to", math.floor(eval(" ".join(execstr)) / 3))
        return math.floor(eval(" ".join(execstr)) / 3)
